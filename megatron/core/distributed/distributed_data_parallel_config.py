...
class DistributedDataParallelConfig:
   ...
   # GMC+ related configs
    use_gmc_plus: bool = False
    """If true, use GMC for distributed optimizer."""

    gmc_sparsity_rate: int = 512
    """Sparsity rate for GMC compression."""
    
    gmc_beta: float = 0.9
    """Momentum coefficient for GMC."""

    gmc_detached_coeff: float = 0.01
    """Detached coefficient for GMC."""
