...
def _add_distributed_args(parser):
    ...
    # gmc+
    group.add_argument('--use-gmc-plus', action='store_true', default=False,
                       help='If set, use GMC+ communication algorithm for data parallelism.')
    group.add_argument('--gmc-beta', type=float, default=0.9,
                       help='Beta parameter for GMC+ algorithm (momentum coefficient).')
    group.add_argument('--gmc-sparsity-rate', type=int, default=512,
                       help='Sparsity rate for GMC+ algorithm.')
    group.add_argument('--gmc-detached-coeff', type=float, default=0.01,
                       help='GMC+ detached coefficient.')
